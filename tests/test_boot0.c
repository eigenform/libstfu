...
static starlet emu;
static u8 nand_data[0x840 * 0x40];
...
int main(void)
{
	...
	// Read the first 0x40 pages from NAND
	...
	starlet_load_nand_buffer(&emu, &nand_data, 0x840*0x40);

	// Break on entry into boot1
	starlet_add_bp(&emu, 0xfff00000);
